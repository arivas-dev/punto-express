                ...
                {[...Array(5)].map((star, i) => {
                    ...
                    return (
                        <label key={i}>
                            ...
                            <svg className={`w-4 h-4 ${product?.rating?.rate >= ratingValue ? 'text-yellow-500' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
